...
date: 'created on 22 November 2020 and updated on 27 March 2026 `r format(Sys.time(), "%d %B, %Y")`'
authors: Johanne Daugbjerg, Anders Pedersen, Benjamin Dammeyer
...
= Added a backslash n (\n) where the lines in the pdf end/commence
